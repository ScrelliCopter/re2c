...
#sourceLocation(file: "02_fill.re", line: 1)
// re2swift $INPUT -o $OUTPUT
import Foundation

#sourceLocation(file: "02_fill.swift", line: 7)
let yymaxfill = 1
#sourceLocation(file: "02_fill.re", line: 4)
...
#sourceLocation(file: "02_fill.swift", line: 61)
      case 2:
#sourceLocation(file: "02_fill.re", line: 40)
        return nil
#sourceLocation(file: "02_fill.swift", line: 65)
      case 3:
        if self.yylimit <= self.yycursor {
          if self.fill(1) != .ok { return nil }
        }
...
#sourceLocation(file: "02_fill.re", line: 39)
        continue loop
#sourceLocation(file: "02_fill.swift", line: 83)
      case 5:
        if self.yylimit <= self.yycursor {
          if self.fill(1) != .ok { return nil }
        }
...
#sourceLocation(file: "02_fill.swift", line: 107)
      case 7:
        if self.yylimit <= self.yycursor {
          if self.fill(1) != .ok { return nil }
        }
...
#sourceLocation(file: "02_fill.re", line: 41)
