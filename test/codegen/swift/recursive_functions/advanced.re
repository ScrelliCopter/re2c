// re2swift $INPUT -o $OUTPUT -cf --recursive-functions
import Foundation
...
/*!re2c
  ...
  re2c:define:YYFN       = ["parse;State.Status", "s;State"];
  re2c:define:YYPEEK     = "s.buffer[s.cursor]";
  re2c:define:YYSKIP     = "s.cursor += 1";
  re2c:define:YYBACKUP   = "s.marker = s.cursor";
  re2c:define:YYRESTORE  = "s.cursor = s.marker";
  re2c:define:YYGETCOND  = "s.cond";
  re2c:define:YYSETCOND  = "s.cond = @@";
  re2c:define:YYGETSTATE = "s.state";
  re2c:define:YYSETSTATE = "s.state = @@";
  re2c:define:YYLESSTHAN = "s.limit <= s.cursor";
  re2c:define:YYFILL     = "return .waiting";
  re2c:define:YYSTAGP    = "@@ = s.cursor";
  re2c:define:YYSTAGN    = "@@ = tagNone";
  re2c:define:YYMTAGP    = "@@ = s.add(tag: @@, value: s.cursor)";
  re2c:define:YYMTAGN    = "@@ = s.add(tag: @@, value: tagNone)";
